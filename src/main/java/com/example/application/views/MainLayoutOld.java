...
public class MainLayoutOld extends AppLayout {
    private final SecurityService securityService;
    private String header;

    public MainLayoutOld(SecurityService securityService) {
...
//        Button logout = new Button("Log out " + username, e -> securityService.logout()); // <2>
...
//        menu.setDefaultHorizontalComponentAlignment(FlexComponent.Alignment.START);
        menu.setHeightFull();
...
//                createTab(VaadinIcon.RECORDS, "Documents"),
                createTab(VaadinIcon.LIST, "List", ListView.class)
